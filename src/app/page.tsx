    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Chat with your <span className="text-indigo-500">documents</span> in seconds.
        </h1>
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4 md:mx-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                Embark on your journey with a no-cost plan or opt for the advanced features available in our {' '}
                <Link href='/pricing' className='text-indigo-600 underline underline-offset-2'>
                  premium plan
                </Link>
                .
              </span>
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4 md:mx-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                We&apos;ll handle your file and prepare it for you to chat with.
              </span>
            </div>
          </li>
          {/* Third Step */}
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4 md:mx-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                It&apos;s that easy! Experiment with PD(IA) today - it really takes less than a minute.
              </span>
            </div>
          </li>
        </ol>
